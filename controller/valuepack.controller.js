...
exports.getvaluepacks = function (req, res, next) {
    try {
        if (req.session) {
...
exports.addvaluepacks = function (req, res, next) {
...
exports.geteditvaluepacks = function (req, res, next) {
    try {
        if (req.session) {
            if (req.session.UserName) {
                mysql.getConnection('PLAN', function (err, connection_ikon_plan) {
...
exports.editvaluepacks = function (req, res, next) {
    try {
        if (req.session) {
            if (req.session.UserName) {
                mysql.getConnection('PLAN', function (err, connection_ikon_plan) {
